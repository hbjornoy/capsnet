if [ ! -f "images_background.zip" ]; then
    wget http://github.com/brendenlake/omniglot/raw/master/python/images_background.zip
fi
if [ ! -f "images_evaluation.zip" ]; then
    wget http://github.com/brendenlake/omniglot/raw/master/python/images_evaluation.zip
fi
